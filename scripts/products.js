...
document.addEventListener('productListFilled', function() {
    ...
    products.forEach(product => {
        const add_val = product.querySelector('.product-val-add');
        const val = product.querySelector('.product-val-indicator');
        const remove_val = product.querySelector('.product-val-remove');

        const add_to_cart = product.querySelector('.product-add-to-cart');  
        const prod_desc = product.querySelector('.product-description');
